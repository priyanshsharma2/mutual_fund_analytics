...
def run_validation():
    ...
    try:
        # Load files safely
        fund_master = pd.read_csv(os.path.join(BASE_DIR, 'data', 'raw', 'cleaned_data', '01_fund_master.csv'))
        nav_history = pd.read_csv(os.path.join(BASE_DIR, 'data', 'raw', 'cleaned_data', '02_nav_history.csv'))
